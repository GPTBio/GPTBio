...
<p align="center">
<a href=""><img src="resources/GPTBio-logo.jpeg" alt="GPTBio logo: 使 GPT 以软件公司的形式工作，协作处理更复杂的任务" width="150px"></a>
</p>
...
cd GPTBio && docker build -t metagpt:v0.3 .
```
...
<img src="resources/20230808-220924.jpg" width = "30%" height = "30%" alt="GPTBio WeChat Discuss Group" align=center />
